...
//[9/21/2017 22:48] Cameron Osborn: This version of implementation uses the original structure of vectors (two for the token values and two for the token categories). A seperate section of the program uses a different implementation, encapsulating the data pertaining to tokens within a class and then creating a vector of that class and then a vector of those vectors to hold all statements in the program.
// OriginalScanner.h is a header file exported for the use of scanner module
